...
var _user$project$Editor_Zipper$itemLast = function (_p0) {
	var _p1 = _p0;
	var _p2 = _elm_lang$core$List$reverse(_p1._2);
	if (_p2.ctor === '[]') {
		return _elm_lang$core$Maybe$Nothing;
	} else {
...
var _user$project$Editor_Zipper$listAfter = function (_p3) {
	var _p4 = _p3;
	return _p4._2;
};
var _user$project$Editor_Zipper$itemNext = function (_p5) {
	var _p6 = _p5;
	var _p7 = _p6._2;
	if (_p7.ctor === '[]') {
		return _elm_lang$core$Maybe$Nothing;
...
var _user$project$Editor_Zipper$itemCurrent = function (_p8) {
	var _p9 = _p8;
	return _p9._1;
};
var _user$project$Editor_Zipper$itemPrevious = function (_p10) {
	var _p11 = _p10;
	var _p12 = _elm_lang$core$List$reverse(_p11._0);
	if (_p12.ctor === '[]') {
		return _elm_lang$core$Maybe$Nothing;
	} else {
...
var _user$project$Editor_Zipper$listBefore = function (_p13) {
	var _p14 = _p13;
	return _elm_lang$core$List$reverse(_p14._0);
};
var _user$project$Editor_Zipper$toList = function (zipper) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_user$project$Editor_Zipper$listBefore(zipper),
		A2(
			_elm_lang$core$Basics_ops['++'],
			{
				ctor: '::',
				_0: _user$project$Editor_Zipper$itemCurrent(zipper),
				_1: {ctor: '[]'}
			},
			_user$project$Editor_Zipper$listAfter(zipper)));
};
var _user$project$Editor_Zipper$itemFirst = function (_p15) {
	var _p16 = _p15;
...
var _user$project$Editor_Zipper$Zipper = F3(
	function (a, b, c) {
		return {ctor: 'Zipper', _0: a, _1: b, _2: c};
	});
var _user$project$Editor_Zipper$singleton = function (item) {
	return A3(
		_user$project$Editor_Zipper$Zipper,
		{ctor: '[]'},
		item,
		{ctor: '[]'});
};
var _user$project$Editor_Zipper$withDefault = function (item) {
	return _elm_lang$core$Maybe$withDefault(
		_user$project$Editor_Zipper$singleton(item));
};
var _user$project$Editor_Zipper$fromList = function (list) {
	var _p18 = list;
	if (_p18.ctor === '[]') {
		return _elm_lang$core$Maybe$Nothing;
	} else {
...
var _user$project$Editor_Zipper$fromListWithDefault = F2(
	function (item, list) {
		var _p19 = list;
		if (_p19.ctor === '[]') {
			return _user$project$Editor_Zipper$singleton(item);
		} else {
			return A3(
				_user$project$Editor_Zipper$Zipper,
				{ctor: '[]'},
...
var _user$project$Editor_Zipper$moveFirst = function (_p20) {
	var _p21 = _p20;
	var _p22 = _elm_lang$core$List$reverse(_p21._0);
	if (_p22.ctor === '[]') {
		return _p21;
	} else {
		return A3(
...
var _user$project$Editor_Zipper$movePrevious = function (_p23) {
	var _p24 = _p23;
	var _p25 = _p24._0;
	if (_p25.ctor === '[]') {
		return _elm_lang$core$Maybe$Nothing;
		...
		return _elm_lang$core$Maybe$Just(
			A3(
				...
				_p25._1,
				_p25._0,
				{ctor: '::', _0: _p24._1, _1: _p24._2}));
	}
};
var _user$project$Editor_Zipper$moveNext = function (_p26) {
	var _p27 = _p26;
	var _p28 = _p27._2;
	if (_p28.ctor === '[]') {
		return _elm_lang$core$Maybe$Nothing;
		...
		return _elm_lang$core$Maybe$Just(
			A3(
				_user$project$Editor_Zipper$Zipper,
				{ctor: '::', _0: _p27._1, _1: _p27._0},
				_p28._0,
				_p28._1));
	}
};
var _user$project$Editor_Zipper$matchNext = F2(
	function (test, _p29) {
		matchNext:
		while (true) {
			var _p30 = _p29;
			var _p32 = _p30;
			if (test(_p30._1)) {
				return _elm_lang$core$Maybe$Just(_p32);
			} else {
				var _p31 = _user$project$Editor_Zipper$moveNext(_p32);
				if (_p31.ctor === 'Just') {
					var _v21 = test,
						_v22 = _p31._0;
					test = _v21;
...
var _user$project$Editor_Zipper$matchFirst = F2(
	function (test, zipper) {
		return A2(
			_user$project$Editor_Zipper$matchNext,
			test,
			_user$project$Editor_Zipper$moveFirst(zipper));
	});
var _user$project$Editor_Zipper$moveLast = function (_p33) {
	var _p34 = _p33;
	var _p35 = _elm_lang$core$List$reverse(_p34._2);
	if (_p35.ctor === '[]') {
		return _p34;
	} else {
		return A3(
...
var _user$project$Editor_Zipper$insertFirst = F2(
	function (item, _p36) {
		var _p37 = _p36;
		return A3(
			_user$project$Editor_Zipper$Zipper,
...
var _user$project$Editor_Zipper$insertBefore = F2(
	function (item, _p38) {
		var _p39 = _p38;
		return A3(
			_user$project$Editor_Zipper$Zipper,
			{ctor: '::', _0: item, _1: _p39._0},
			_p39._1,
			_p39._2);
	});
var _user$project$Editor_Zipper$insertAfter = F2(
	function (item, _p40) {
		var _p41 = _p40;
		return A3(
			_user$project$Editor_Zipper$Zipper,
			_p41._0,
			_p41._1,
			{ctor: '::', _0: item, _1: _p41._2});
	});
var _user$project$Editor_Zipper$insertLast = F2(
	function (item, _p42) {
		var _p43 = _p42;
		return A3(
			_user$project$Editor_Zipper$Zipper,
...
var _user$project$Editor_Zipper$deleteBefore = function (_p44) {
	var _p45 = _p44;
	return A3(
		_user$project$Editor_Zipper$Zipper,
		{ctor: '[]'},
...
var _user$project$Editor_Zipper$deleteBackward = function (_p46) {
	var _p47 = _p46;
	var _p48 = _p47._0;
	if (_p48.ctor === '[]') {
		return _elm_lang$core$Maybe$Nothing;
		...
		return _elm_lang$core$Maybe$Just(
			A3(_user$project$Editor_Zipper$Zipper, _p48._1, _p48._0, _p47._2));
	}
};
var _user$project$Editor_Zipper$deleteBackwardForward = function (_p49) {
	var _p50 = _p49;
	var _p54 = _p50._0;
	var _p53 = _p50._2;
	var _p51 = _p54;
	if (_p51.ctor === '[]') {
		...
		if (_p52.ctor === '[]') {
			...
			return _elm_lang$core$Maybe$Just(
				A3(_user$project$Editor_Zipper$Zipper, _p54, _p52._0, _p52._1));
		}
	} else {
		return _elm_lang$core$Maybe$Just(
			A3(_user$project$Editor_Zipper$Zipper, _p51._1, _p51._0, _p53));
	}
};
var _user$project$Editor_Zipper$deleteForwardBackward = function (_p55) {
	var _p56 = _p55;
	var _p60 = _p56._0;
	var _p59 = _p56._2;
	var _p57 = _p59;
	if (_p57.ctor === '[]') {
		...
		if (_p58.ctor === '[]') {
			...
			return _elm_lang$core$Maybe$Just(
				A3(_user$project$Editor_Zipper$Zipper, _p58._1, _p58._0, _p59));
		}
	} else {
		return _elm_lang$core$Maybe$Just(
			A3(_user$project$Editor_Zipper$Zipper, _p60, _p57._0, _p57._1));
	}
};
var _user$project$Editor_Zipper$deleteForward = function (_p61) {
	var _p62 = _p61;
	var _p63 = _p62._2;
	if (_p63.ctor === '[]') {
		return _elm_lang$core$Maybe$Nothing;
		...
		return _elm_lang$core$Maybe$Just(
			A3(_user$project$Editor_Zipper$Zipper, _p62._0, _p63._0, _p63._1));
	}
};
var _user$project$Editor_Zipper$deleteAfter = function (_p64) {
	var _p65 = _p64;
	return A3(
		_user$project$Editor_Zipper$Zipper,
		_p65._0,
...
var _user$project$Editor_Zipper$map = F2(
	function (op, _p66) {
		var _p67 = _p66;
		return A3(
			_user$project$Editor_Zipper$Zipper,
			A2(_elm_lang$core$List$map, op, _p67._0),
			op(_p67._1),
			A2(_elm_lang$core$List$map, op, _p67._2));
	});
var _user$project$Editor_Zipper$mapBefore = F2(
	function (op, _p68) {
		var _p69 = _p68;
		return A3(
			_user$project$Editor_Zipper$Zipper,
			A2(_elm_lang$core$List$map, op, _p69._0),
			_p69._1,
			_p69._2);
	});
var _user$project$Editor_Zipper$mapCurrent = F2(
	function (op, _p70) {
		var _p71 = _p70;
		return A3(
			_user$project$Editor_Zipper$Zipper,
...
var _user$project$Editor_Zipper$mapAfter = F2(
	function (op, _p72) {
		var _p73 = _p72;
		return A3(
			_user$project$Editor_Zipper$Zipper,
			_p73._0,
			_p73._1,
			A2(_elm_lang$core$List$map, op, _p73._2));
	});

var _user$project$Editor_Data$entryEncoder = function (entry) {
	var summary_ = function () {
		var _p0 = entry.summary;
		if (_p0.ctor === 'Just') {
	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'id',
				_1: _elm_lang$core$Json_Encode$int(entry.id)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'page',
					_1: _elm_lang$core$Json_Encode$int(entry.page)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'text',
						_1: _elm_lang$core$Json_Encode$string(entry.text)
					},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'summary', _1: summary_},
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Editor_Data$recordEncoder = function (record) {
	var entries_ = _user$project$Editor_Zipper$toList(record.entries);
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
...
var _user$project$Editor_Data$zipperEncoder = function (zipper) {
	var list = _user$project$Editor_Zipper$toList(zipper);
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				...
				_0: 'records',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Editor_Data$recordEncoder, list))
			},
			_1: {ctor: '[]'}
		});
};
var _user$project$Editor_Data$JsonRoot = function (a) {
	return {records: a};
};
var _user$project$Editor_Data$Model = F2(
	function (a, b) {
		return {simple: a, records: b};
	});
var _user$project$Editor_Data$Record = F5(
	function (a, b, c, d, e) {
		return {id: a, name: b, category: c, firstPage: d, entries: e};
	});
var _user$project$Editor_Data$RecordZ = F5(
	function (a, b, c, d, e) {
		return {id: a, name: b, category: c, firstPage: d, entries: e};
	});
var _user$project$Editor_Data$Entry = F4(
	function (a, b, c, d) {
		return {id: a, page: b, text: c, summary: d};
	});
var _user$project$Editor_Data$defaultEntry = function (id) {
	return A4(_user$project$Editor_Data$Entry, id, 0, '', _elm_lang$core$Maybe$Nothing);
};
var _user$project$Editor_Data$entryDecoder = A4(
	...
	A3(
		...
		A3(
			...
			A3(
				...
				'id',
				_elm_lang$core$Json_Decode$int,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Editor_Data$Entry)))));
var _user$project$Editor_Data$Invalid = {ctor: 'Invalid'};
var _user$project$Editor_Data$World = {ctor: 'World'};
var _user$project$Editor_Data$Power = {ctor: 'Power'};
var _user$project$Editor_Data$Character = {ctor: 'Character'};
var _user$project$Editor_Data$defaultRecord = function (id) {
	return A5(
		_user$project$Editor_Data$Record,
		id,
		'',
		_user$project$Editor_Data$Character,
		0,
		{
			ctor: '::',
			_0: _user$project$Editor_Data$defaultEntry(0),
			_1: {ctor: '[]'}
		});
};
var _user$project$Editor_Data$defaultRecordList = {
	ctor: '::',
	_0: _user$project$Editor_Data$defaultRecord(0),
	_1: {ctor: '[]'}
};
var _user$project$Editor_Data$defaultRecordZ = function (id) {
	return A5(
		_user$project$Editor_Data$RecordZ,
		id,
		'',
		_user$project$Editor_Data$Character,
		0,
		_user$project$Editor_Zipper$singleton(
			_user$project$Editor_Data$defaultEntry(0)));
};
var _user$project$Editor_Data$defaultRecordZList = _user$project$Editor_Zipper$singleton(
	_user$project$Editor_Data$defaultRecordZ(0));
var _user$project$Editor_Data$categoryDecoder = function (string) {
	var category = function () {
		var _p1 = _elm_lang$core$String$toLower(string);
		switch (_p1) {
			case 'character':
				return _user$project$Editor_Data$Character;
			case 'power':
				return _user$project$Editor_Data$Power;
			case 'world':
				return _user$project$Editor_Data$World;
			default:
				return _user$project$Editor_Data$Invalid;
		}
	}();
	return _elm_lang$core$Json_Decode$succeed(category);
};
var _user$project$Editor_Data$recordDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'entries',
	_elm_lang$core$Json_Decode$list(_user$project$Editor_Data$entryDecoder),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'firstPage',
		_elm_lang$core$Json_Decode$int,
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'category',
			A2(_elm_lang$core$Json_Decode$andThen, _user$project$Editor_Data$categoryDecoder, _elm_lang$core$Json_Decode$string),
			A3(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
				'name',
				_elm_lang$core$Json_Decode$string,
				A3(
					...
					'id',
					_elm_lang$core$Json_Decode$int,
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Editor_Data$Record))))));
var _user$project$Editor_Data$dataDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'records',
	_elm_lang$core$Json_Decode$list(_user$project$Editor_Data$recordDecoder),
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Editor_Data$JsonRoot));

var _user$project$Editor_Editor$jsonExport = _elm_lang$core$Native_Platform.outgoingPort(
	'jsonExport',
	function (v) {
		return v;
	});
...
var _user$project$Editor_Editor$UpdateSummary = F2(
	function (a, b) {
		return {ctor: 'UpdateSummary', _0: a, _1: b};
	});
var _user$project$Editor_Editor$UpdateText = F2(
	function (a, b) {
		return {ctor: 'UpdateText', _0: a, _1: b};
	});
var _user$project$Editor_Editor$UpdatePage = F2(
	function (a, b) {
		return {ctor: 'UpdatePage', _0: a, _1: b};
	});
var _user$project$Editor_Editor$entryItemView = function (entry) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('item entry'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
					...
					_0: A2(
						_elm_lang$html$Html$input,
						{
							...
							_0: _elm_lang$html$Html_Attributes$value(
								_elm_lang$core$Basics$toString(entry.page)),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(
									_user$project$Editor_Editor$UpdatePage(entry.id)),
								_1: {
									ctor: '::',
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$value(entry.text),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(
												_user$project$Editor_Editor$UpdateText(entry.id)),
											_1: {ctor: '[]'}
										}
									},
									{ctor: '[]'}),
								...
								},
								{
									...
									_0: A2(
										_elm_lang$html$Html$textarea,
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$value(
												A2(_elm_lang$core$Maybe$withDefault, '', entry.summary)),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onInput(
													_user$project$Editor_Editor$UpdateSummary(entry.id)),
												_1: {ctor: '[]'}
											}
										},
										{ctor: '[]'}),
						...
						_elm_lang$html$Html$button,
						{
							...
							_1: {
								...
								_0: _elm_lang$html$Html_Events$onClick(
									_user$project$Editor_Editor$DeleteEntry(entry.id)),
								_1: {ctor: '[]'}
							}
						},
						{
...
var _user$project$Editor_Editor$UpdateName = function (a) {
	return {ctor: 'UpdateName', _0: a};
};
var _user$project$Editor_Editor$AddEntry = function (a) {
	return {ctor: 'AddEntry', _0: a};
};
var _user$project$Editor_Editor$RequestEntry = {ctor: 'RequestEntry'};
var _user$project$Editor_Editor$entryAddView = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('add entry'),
		_1: {
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onClick(_user$project$Editor_Editor$RequestEntry),
			_1: {ctor: '[]'}
		}
	},
	{
...
var _user$project$Editor_Editor$DeleteRecord = function (a) {
...
var _user$project$Editor_Editor$recordHeaderView = function (record) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('header record'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$value(record.name),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onInput(_user$project$Editor_Editor$UpdateName),
						_1: {
							ctor: '::',
...
var _user$project$Editor_Editor$rightView = function (record) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('panel right'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _user$project$Editor_Editor$recordHeaderView(record),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('container entry'),
						_1: {ctor: '[]'}
					},
					A2(
						_elm_lang$core$List$map,
						_user$project$Editor_Editor$entryItemView,
						_user$project$Editor_Zipper$toList(record.entries))),
				_1: {
					ctor: '::',
					_0: _user$project$Editor_Editor$entryAddView,
					_1: {ctor: '[]'}
				}
			}
		});
};
var _user$project$Editor_Editor$SelectRecord = function (a) {
	return {ctor: 'SelectRecord', _0: a};
};
var _user$project$Editor_Editor$recordItemView = function (record) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('item record'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$Editor_Editor$SelectRecord(record.id)),
				_1: {ctor: '[]'}
			}
		},
		{
...
var _user$project$Editor_Editor$AddRecord = function (a) {
		...
		switch (_p4.ctor) {
				...
				var entries_ = A2(
					...
					A2(
						...
						A2(
							_user$project$Editor_Zipper$withDefault,
							_user$project$Editor_Data$defaultEntry(0),
							_user$project$Editor_Zipper$fromList(
								A2(
									_elm_lang$core$List$sortBy,
									function (_) {
										return _.page;
									},
									_user$project$Editor_Zipper$toList(
										A2(
											_user$project$Editor_Zipper$mapCurrent,
											function (e) {
												return _elm_lang$core$Native_Utils.update(
						...
						A2(
							...
							_elm_lang$core$List$head(
								A2(
									...
									_user$project$Editor_Zipper$toList(entries_))))));
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						_p10,
					...
					_1: A2(
						_elm_lang$core$Task$attempt,
						_elm_lang$core$Basics$always(_user$project$Editor_Editor$NoOp),
			...
			case 'DeleteEntry':
				var entries_ = A2(
					_user$project$Editor_Zipper$withDefault,
					_user$project$Editor_Data$defaultEntry(0),
					_user$project$Editor_Zipper$deleteForwardBackward(
						A2(
							_user$project$Editor_Zipper$withDefault,
							_user$project$Editor_Data$defaultEntry(0),
							A2(
...
var _user$project$Editor_Editor$recordAddView = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('add record'),
		_1: {
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onClick(_user$project$Editor_Editor$RequestRecord),
			_1: {ctor: '[]'}
		}
	},
	{
...
var _user$project$Editor_Editor$leftView = function (records) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('container record'),
					_1: {ctor: '[]'}
				},
				A2(
					_elm_lang$core$List$map,
					function (r) {
						return _user$project$Editor_Editor$recordItemView(r);
					},
					_user$project$Editor_Zipper$toList(records))),
			_1: {
				ctor: '::',
				_0: _user$project$Editor_Editor$recordAddView,
				_1: {ctor: '[]'}
			}
		});
};
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('export'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_user$project$Editor_Editor$ExportJson),
								_1: {ctor: '[]'}
							}
						},
						{
...
var _user$project$Main$convertListsToZippers = function (simple) {
	var recordToRecordZ = function (_p0) {
		var _p1 = _p0;
		return A5(
			_user$project$Editor_Data$RecordZ,
			_p1.id,
			...
			A2(
				_user$project$Editor_Zipper$withDefault,
				_user$project$Editor_Data$defaultEntry(123),
				_user$project$Editor_Zipper$fromList(
					A2(
						_elm_lang$core$List$sortBy,
						function (_) {
	...
	var records = A2(_elm_lang$core$List$map, recordToRecordZ, simple);
	return A2(
		_user$project$Editor_Zipper$withDefault,
		_user$project$Editor_Data$defaultRecordZ(456),
		_user$project$Editor_Zipper$fromList(records));
};
var _user$project$Main$init = A2(_user$project$Editor_Data$Model, _user$project$Editor_Data$defaultRecordList, _user$project$Editor_Data$defaultRecordZList);
var _user$project$Main$ImportDataHandler = function (a) {
	return {ctor: 'ImportDataHandler', _0: a};
};
var _user$project$Main$importDataCmd = A2(
	_elm_lang$http$Http$send,
	_user$project$Main$ImportDataHandler,
	A2(_elm_lang$http$Http$get, 'data.json', _user$project$Editor_Data$dataDecoder));
...
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p2 = msg;
		if (_p2.ctor === 'EditorMsg') {
			var _p3 = A2(_user$project$Editor_Editor$update, _p2._0, model);
			var model_ = _p3._0;
			var cmd = _p3._1;
			return {
				ctor: '_Tuple2',
				_0: model_,
				_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$EditorMsg, cmd)
			};
		} else {
			var _p4 = _p2._0;
			if (_p4.ctor === 'Ok') {
				var simple = _p4._0.records;
				var records_ = _user$project$Main$convertListsToZippers(simple);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{simple: simple, records: records_}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			} else {
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		_user$project$Editor_Editor$view(model));
};
var _user$project$Main$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _user$project$Main$init, _1: _user$project$Main$importDataCmd},
